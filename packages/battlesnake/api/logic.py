...
#
# This file holds your Battlesnake logic and helper functions.
# It is pure stdlib (no Flask) so it can be imported by both the local Flask
# server (server.py) and the DigitalOcean Function (__main__.py).
